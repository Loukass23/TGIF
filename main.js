...
function startMain(membersObj) {
  ...
  new Vue({
    ...
    method: {
      ...
      addListeners() {
        document.getElementById('checkboxPty').addEventListener('change', this.filters);
        document.getElementById('dropDownStates').addEventListener('change', this.filters);
      }},
      created() {
